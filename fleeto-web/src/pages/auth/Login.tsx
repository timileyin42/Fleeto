      ...
      <div className="w-full max-w-[420px] bg-surface-container-lowest rounded-xl shadow-card p-xl border border-outline-variant/30">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-lg">
          <div className="flex flex-col gap-xs">
            <label className="font-mono text-mono-label text-on-surface-variant uppercase" htmlFor="email">
              Email Address
            </label>
            <input
              id="email"
              ...
              className="w-full bg-surface-container-lowest border border-outline-variant rounded-xl px-md py-3 text-body-md text-on-surface placeholder:text-outline focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
            />
          </div>
        ...
        <p className="text-center text-body-sm text-on-surface-variant mt-lg">
          No account?{' '}
          <Link to="/signup" className="text-on-surface font-semibold hover:underline">
            Sign up
          </Link>
        </p>
        <p className="text-center text-body-sm text-on-surface-variant mt-sm">
          Rider?{' '}
          <Link to="/rider/login" className="text-on-surface font-semibold hover:underline">
            Rider login
          </Link>
        </p>
      </div>
